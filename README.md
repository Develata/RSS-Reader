...
- 如果你本地自己执行 `dx bundle --platform android ...`，记得随后运行 `python3 scripts/prepare_android_bundle.py target/dx/rssr-app/release/android/app/app/src/main`，这样 Android 启动图标和应用显示名会统一为 `RSS-Reader / RSSR`
