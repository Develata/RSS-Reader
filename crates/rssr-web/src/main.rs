...
fn resolve_session_secret(auth_state_file: &std::path::Path) -> Result<String> {
...
fn load_persisted_password_hash(auth_state_file: &std::path::Path) -> Result<Option<String>> {
